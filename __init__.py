...
def authentification():
    if request.method == 'POST':
        ...
        if request.form['username'] == 'admin' and request.form['password'] == "password" or request.form['username'] == user and resquest.form['password'] == '12345': # password à cacher par la suite
